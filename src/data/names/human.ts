...
export const Human: Races.NameDefinition = {
    ...
    parts: {
        /** Adapted from http://www.fantasynamegenerators.com/english_names.php **/
        forename: {
            markovOrder: 2,
            mode: "item",
            source: {
                "M": [
                    ...
                    "scott", "sean", "sebastian", "spencer", "stanley", "taylor", "theo", "thomas", "toby", "tom", "tommy", "tyler",
        ...
        /* Adapted from http://www.fantasynamegenerators.com/fantasy-surnames.php */
        surnamePrefix: {
            markovOrder: 2,
            mode: "item",
            source: {
